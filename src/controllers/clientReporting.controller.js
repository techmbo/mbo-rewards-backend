...
export async function clientListOrdersHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "orders" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientListPaymentsHandler(req, res, next) {
  try {
    const clientId = requirePartnerClient(req, res);
    if (!clientId) return;
    sendClientBoundaryJson(res, payload, { surface: "payments" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientListCampaignsAliasHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "campaigns" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientPerformanceAliasHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "performance" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientListConfirmedOrdersHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "confirmed_orders" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientPerformanceAffiliateLinksHandler(req, res, next) {
  try {
    ...
    if (!clientId) return;
    const payload = await reporting.listPerformance(clientId, req.query ?? {});
    sendClientBoundaryJson(res, splitPerformanceItems(payload, "affiliate"), { surface: "performance" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientPerformanceCouponsHandler(req, res, next) {
  try {
    ...
    if (!clientId) return;
    const payload = await reporting.listPerformance(clientId, req.query ?? {});
    sendClientBoundaryJson(res, splitPerformanceItems(payload, "coupon"), { surface: "performance" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientListStatementsHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "statements" });
  } catch (error) {
    next(error);
  }
}
...
export async function clientListWithdrawalsHandler(req, res, next) {
  try {
    ...
    sendClientBoundaryJson(res, payload, { surface: "withdrawals" });
  } catch (error) {
    next(error);
  }
}
