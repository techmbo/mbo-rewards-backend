...
export class NetworkOpsService {
  ...
  #hasCredentials(account) {
    return Boolean(account.maskedApiKey) || Boolean(account.encryptedAccessToken);
  }
  ...
  #assembleNetwork(key, agg, live, scheduler) {
    ...
    return {
      ...
      accounts: accounts.map((a) => ({
        ...
        lastSuccessfulSync: a.lastSuccessfulSync,
        lastCampaignSyncAt: a.lastCampaignSyncAt,
        lastCouponSyncAt: a.lastCouponSyncAt,
        lastOrderSyncAt: a.lastOrderSyncAt,
        lastPaymentSyncAt: a.lastPaymentSyncAt,
        syncFrequencyMinutes: a.syncFrequencyMinutes ?? null,
        lastAuthCheckAt: a.lastAuthCheckAt,
  ...
  async getNetwork(keyOrId) {
    ...
    return toNetworkDetailDto(this.#assembleNetwork(key, agg, live, scheduler));
  }
}
