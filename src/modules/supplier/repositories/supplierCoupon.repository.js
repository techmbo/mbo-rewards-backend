...
function buildWhere(filters = {}) {
  ...
  if (filters.networkSource) {
    const term = String(filters.networkSource).trim();
    and.push({
      OR: [
        { networkSource: { contains: term, mode: "insensitive" } },
        { supplierCampaign: { supplier: { contains: term, mode: "insensitive" } } },
      ],
    });
  }
  ...
  if (filters.search) {
    ...
    and.push({
      OR: [
        ...
        { promotionDescription: { contains: term, mode: "insensitive" } },
